    ...
    try {
        if ($action == 'Approved') {
            ...
            if ($log_data) {
                ...
                $hours_data = calculateHoursWorked($time_in, $time_out);
                $hours_worked = $hours_data['hours'] + ($hours_data['minutes'] / 60); // Convert to decimal hours
                ...
                // Update total hours in students table first
                ...
                // Update all approved logs for this student with new total
